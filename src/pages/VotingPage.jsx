...
import {
  Container, Card, CardBody, CardHeader, Button, Row, Col, Alert
} from "reactstrap";
...
<Row>
{candidates.length==0?(<p>No candidate available</p>):(
      ...
      <Col key={candidate.id} md="4" className="mb-4">
        <Card>
          ...
          <CardBody>
            ...
            <Button color="primary" onClick={() => handleVote(candidate.id)}>
              Vote
            </Button>
          </CardBody>
        </Card>
